...
<head>
    ...
    <title>Lista da Disciplina Master (aluno)</title>
    <script>
...
<?php
    include  "menu.php" ;
?>
    <a href="caddisciplinamaster.php">Nova Disciplina</a>
    <form method="POST">
        ...
        <br>
        <a href="alistardisciplinamaster.php">Listar todas as Disciplinas</a><br><br>
    ...
    ?>
        ...
        <table>
            <tr>
                ...
                <th>Nome da Turma</th>
                <th>Alterar Alunos da Disciplina</th>
